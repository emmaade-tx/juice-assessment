            ...
            <div ref={topRef} className="container terms-wrapper">
                ...
                <div className="terms-texts">
                    <p className="roobert-regular-normal-black-18px">
                        ...
                        Our collection and use of your personal information in connection with your use of our services is described in our Privacy Policy. <br/>
                    ...
                    <h1 className="roobert-bold-black-long-18px">Definitions</h1>
                    <p className="roobert-regular-normal-black-18px">
                        In these Terms, <br /><br />

                        “Account” <br />
                        means a unique personified account registered in the name of the User and which contains details of the User’s transactions/operations on the Platform (as defined below). <br /><br />

                        “Applicable Laws” <br />
                        means all applicable regulations, laws, codes, guidelines, policies, rules, and directives of any competent regulatory authority in the Federal Republic of Nigeria. <br /><br />

                        “Mobile Application” <br />
                        means any mobile application developed by Juice Track. <br /><br />

                        “Platform” <br />
                        means, collectively Juice Track’s website, mobile application and other related applications provided by Juice Track. <br /><br />

                        “Service(s)” <br />
                        means all products and services provided to you by Juiice Incand as described in clause 3 of these Terms. <br /><br />

                        “Merchants” <br />
                        means any businesses engaged by Juiice Incto provide financial services to. <br /><br />

                        “User” <br />
                        means persons, customers and visitors who access the Service.
                    </p>
                    <h1 className="roobert-bold-black-long-18px">Acceptance of Terms</h1>
                    <p className="roobert-regular-normal-black-18px">
                        The Service is offered subject to acceptance of all the terms and conditions contained in these Terms and all other operating rules, policies, and procedures that may be published on the Platform, which are incorporated by reference, including operating rules, policies, and procedures of third-party service providers to the Platform that are referenced herein. These Terms apply to every user of the Service. In addition, some Services offered through the Platform may be subject to additional terms and conditions adopted by the Platform. Your use of those Services is subject to those additional terms and conditions, which are incorporated into these Terms by this reference. <br/>
                    ...
                    <h1 className="roobert-bold-black-long-18px">Scope of Juice Track’s Services</h1>
                    <p className="roobert-regular-normal-black-18px">
                        Juiice Inc. is an elogistics technology company that provides a means for merchants to track their shipped goods in realtime.<br />
                        Our Services can be accessed through a web and mobile applications.<br />
                        To access the Service, a User is required to sign up on the Platform and create an account (Juiice IncAccount) by providing the User’s name, email and password.<br />
                        A User is granted access to use the Platform and has a responsibility to ensure that no third party shall gain access to the User’s account information.<br />
                        Juiice Incmay make the access to the Platform and the Services, or certain areas or features of the Platform, subject to certain conditions or requirements, such as, meeting specific eligibility criteria (KYC verification).<br />
                        You must be at least 18 years old and able to enter into legally binding contracts to access and use of the Services. By accessing or using the Platform, you represent and warrant that you are 18 or older and have the legal capacity and authority to enter into a contract.<br />
                        Juiice Inc. will ask users to provide a form of legal or government identification for verification.<br />
                        You agree to strictly observe the security and authentication procedures of the Platform and you will log out from the Platform at the end of every visit.<br />
                    ...
                    <h1 className="roobert-bold-black-long-18px">Users’ Representations & Warranties</h1>
                    <p className="roobert-regular-normal-black-18px">
                        Representations and warranties are statements and promises made by you to Juice Track, which we rely on as being accurate in our dealings with you. You make the following representations and warranties to us at the time of agreeing to these Terms and every time you use the Services; <br />
                        ...
                        all personal information that you provide about yourself is accurate and true to the best of your knowledge; <br />
                        all information that you provide about your company is accurate and true; <br />
                        all information that you provide about your government identification data(s) is accurate and true; <br />
                    ...
                    <h1 className="roobert-bold-black-long-18px">Payment</h1>
                    <p className="roobert-regular-normal-black-18px">
                        Our shipment tracking software is provided via a subscription-based arrangement for which you shall be required to pay the stipulated subscription fee based on your subscription.<br />
                        Payment for shipment tracking shall be made within 30 (thirty), 90 (ninety) or 180 (one hundred and eighty) days of receiving an invoice from Juice Track, based on your preferred subscription option, and the services shall only be provided after the invoice is settled.<br />
                        Juiice Increserves the right to adjust its pricing where necessary. <br />
                        Payments to Juiice Incshall be made only through virtual card charging. <br />
                        You warrant that you shall provide complete and accurate payment information.<br />
                        By providing your credit or debit card and other payment information accepted by our payment service provider, you are expressly agreeing that we are authorised to charge the relevant fees for your use of the Service, together with any applicable taxes.<br />
                        ...
                        Each subscription’s automatic renewal is for the same period of time as your original subscription.  You may cancel your subscription at any time by contacting Juiice Incat info@Juiceafrica.com. Any subscription fees charged prior to the effective date of cancellation will not be refunded, in whole.<br />
                        You will not be eligible for a pro-rated refund of any portion of the subscription fees paid for any unused days of the then-current subscription term. If you cancel your subscription, you will enjoy your subscription benefits until the expiration of the then-current subscription term for which you have paid, and your subscription benefits will expire at the end of the then-current subscription term.<br />
                    ...
                    <h1 className="roobert-bold-black-long-18px">Merchants</h1>
                    <p className="roobert-regular-normal-black-18px">
                    ...
                    <p className="roobert-regular-normal-black-18px">
                        ...
                        Subject to your compliance with these Terms, Juiice Incgrants you a limited, non-exclusive, non-sub licensable, revocable, non-transferable license to access and view any Collective Content made available on or through the Platform and accessible to you, solely for your personal and non-commercial use.<br />
                        ...
                        Special Provisions for Mobile Applications <br />
                        Juiice Inc may make available Mobile Applications to access the Services via a mobile device.  To use the Mobile Application, you must have a mobile device that is compatible with the mobile service.<br />
                        ...
                        Standard data charges from your mobile network or internet service provider may apply to your use of the Mobile Application.<br />
                        ...
                        Your use of Juice Track’s iOS App must comply with Apple’s current App Store Terms of Service.<br />
                        ...
                        You acknowledge that these Terms are between you and Juiice Inconly, and not with Google, Inc. (“Google”).<br />
                        Your use of Juice Track’s Android App must comply with Google’s current Android Market Terms of Service.<br />
                    ...
                    <h1 className="roobert-bold-black-long-18px">Prohibited Activities</h1>
                    <p className="roobert-regular-normal-black-18px">
                        ...
                        Users shall not utilize the Platform or the Services for any illegal purpose.<br />
                    ...
                    <h1 className="roobert-bold-black-long-18px">Termination</h1>
                    <p className="roobert-regular-normal-black-18px">
                    ...
                    <h1 className="roobert-bold-black-long-18px">Indemnity</h1>
                    <p className="roobert-regular-normal-black-18px">
                    ...
                    <h1 className="roobert-bold-black-long-18px">Limitation of Liability</h1>
                    <p className="roobert-regular-normal-black-18px">
                    ...
                    <h1 className="roobert-bold-black-long-18px">Disclaimer</h1>
                    <p className="roobert-regular-normal-black-18px">
                        ...
                        For the digital healthcheck report services provided by Juice Track, Juiice Incshall not be responsible for any damage that occurs to your shipment(s) where, after receiving a digital health report on your shipment(s), such report is taken to an external Merchants for subsequent tracking. 
                    </p>

                    <h1 className="roobert-bold-black-long-18px">Governing Law</h1>
                    <p className="roobert-regular-normal-black-18px">
                    ...
                    <h1 className="roobert-bold-black-long-18px">Dispute Resolution</h1>
                    <p className="roobert-regular-normal-black-18px">
                    ...
                    <h1 className="roobert-bold-black-long-18px">Force Majeure</h1>
                    <p className="roobert-regular-normal-black-18px">
                    ...
                    <h1 className="roobert-bold-black-long-18px">Feedback</h1>
                    <p className="roobert-regular-normal-black-18px">
                    ...
                    <h1 className="roobert-bold-black-long-18px">Contact Us</h1>
                    <p className="roobert-regular-normal-black-18px">
